...
nv.models.line = function() {
  ...
  var margin = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , transitionDuration = 0 // controls the line transition duration
    ;
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var trg = groups
          .transition();
          trg.duration(transitionDuration);
          trg
          .style('stroke-opacity', 1)
      ...
      var aptr = areaPaths
          .transition();
          aptr.duration(transitionDuration);
          aptr.attr('d', function(d) {
            return d3.svg.area()
                .interpolate(interpolate)
                .defined(defined)
...
nv.models.lineChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      linesWrap.transition().duration(transitionDuration).call(lines);
